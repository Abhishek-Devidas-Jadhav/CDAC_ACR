...
try:
  import_module_dir = os.path.join(os.getcwd(), f"{config.project_home}/server/.finetuned_model_export")
except:
  import_module_dir = os.path.join(os.getcwd(), f"{project_home}/server/.finetuned_model_export")
